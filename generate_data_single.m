function [A, At, Gw] = generate_data_single(Nx,Ny,f,super_res,seed)
...
% seed: random seed for random number generation. This is important in
...
%     figure, scatter(u1,v1,'r.'); % Uncomment to plot
%     xlim([-pi, pi]);
%     ylim([-pi, pi]);
%     saveas(gcf, 'sampling_pattern.png'); 
end
